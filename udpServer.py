        ...
        if ":" in message and score_labels and player_frames:
            try:
                ...
                if target_id == 43 and player_scores[shooter_id]["team"] == "Red":
                    log_event(f" Red {shooter_id} scored on Green base!")
            ...
            log_event(f"Unknown message: {message}")
